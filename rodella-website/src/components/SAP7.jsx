...
const SAP7 = ({ onImageLoad, imageLoaded }) => {
    const drone = Products.find((p) => p.id === 2);
            ...
            <section className="pt-2">
                ...
                <div className="flex lg:flex-row min-h-screen lg:px-50 py-2 flex-col">
                    ...
                    <div className="w-full h-full">
                        <img src={drone.OtherImg} className="object-cover w-full h-full" alt="SAP7" />
                    </div>
                </div>
            </section>
        </div>
