...
const ContactUs = () => {
  ...
  return (
    <div className="flex flex-col h-auto md:h-screen bg-gray-900 text-white">
      {/* Centered Heading */}
      <div className="flex justify-center items-center p-6 md:p-10">
        <h1 className="section-title text-white text-3xl md:text-5xl font-Gilroy text-center">
          Contact Us
        </h1>
      </div>
      ...
      <div className="flex flex-col md:flex-row h-full flex-grow">
        ...
        <div className="flex-1 flex flex-col justify-start p-4 md:p-10">
          <div className="contact__us_text bg-[#24253C] p-4 rounded-lg mb-6 text-center">
            <p className="text-white text-sm md:text-lg font-Gilroy">
          ...
          <div className="contact_us_contacts bg-[#24253C] p-4 rounded-lg mb-6 text-center">
            <p className="text-white text-sm md:text-lg font-Gilroy mb-2">
              Contact Details:
            </p>
            <p className="text-white text-sm md:text-lg font-Gilroy mb-2">
              4, Mount View Villas, Kolar Rd, Chuna Bhatti, Bhopal, Madhya
              Pradesh 462016
            </p>
          ...
          <div className="contact_us_socials bg-[#24253C] p-4 rounded-lg mb-4 text-center">
            <h3 className="contact__us_socials--title text-white text-sm md:text-lg font-Gilroy mb-2">
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-4 md:p-10 w-full md:w-1/2">
